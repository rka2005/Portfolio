...
void main(){
  ...
  vec3 color = mix(uColorA, uColorB, normCoord.x);
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const uniforms = {
        ...
        uColorB: { value: new THREE.Color(colorB) },        uClickPos: {
    ...
    window.addEventListener('pointermove', onPointerMove, {
      ...
      threeRef.current = {
        ...
        t.uniforms.uColorA.value.set(colorA);
        t.uniforms.uColorB.value.set(colorB);
